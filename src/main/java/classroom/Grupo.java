...
public class Grupo {
    ...
    public /*final*/ int codigo = 0; //No se puede cambiar el valor de una variable final
    ...
    public Grupo(int cantidadEstudiantes, Persona profesor, Asignatura asignatura, int codigo, String horario) {
        ...
        this(new Persona[cantidadEstudiantes], profesor, asignatura, codigo, horario); //Reemplacé personas por new Persona[cantidadEstudiantes]
    }
